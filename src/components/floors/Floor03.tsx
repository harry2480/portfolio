      ...
      <div className="pt-32 px-6 pb-20 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="border border-white/20 p-6 rounded-sm">
            <h3 className="font-bebas text-2xl mb-4 text-white">FRONTEND</h3>
          ...
          <div className="border border-white/20 p-6 rounded-sm">
            <h3 className="font-bebas text-2xl mb-4 text-white">BACKEND</h3>
            <ul className="space-y-3 text-sm text-gray-400 font-sans">
          ...
          <div className="border border-white/20 p-6 rounded-sm">
            <h3 className="font-bebas text-2xl mb-4 text-white">DEVOPS</h3>
            <ul className="space-y-3 text-sm text-gray-400 font-sans">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 bg-[#0f0f0f] border border-white/10 rounded-sm">
            <h4 className="font-bebas text-xl mb-2 text-white">Experiment: Real-time Data Viz</h4>
            <p className="text-sm text-gray-400">Interactive WebGL visualizations using Three.js to explore streaming data.</p>
          </div>
          <div className="p-6 bg-[#0f0f0f] border border-white/10 rounded-sm">
            <h4 className="font-bebas text-xl mb-2 text-white">Tooling & Scripts</h4>
